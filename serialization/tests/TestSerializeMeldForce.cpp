...
void testDistRestSerialization() {
    ...
    for (int i = 0; i < force.getNumDistRestraints(); i++) {
        ...
        float eco_constanta, eco_constantb;
        float eco_lineara, eco_linearb;
        int res_index1a, res_index1b, res_index2a, res_index2b;
        force.getDistanceRestraintParams(i, atom1a, atom2a, r1a, r2a, r3a, r4a, forceConstanta, doing_ecoa, eco_factora, eco_constanta, eco_lineara, res_index1a, res_index2a, globalIndexa);
        force2.getDistanceRestraintParams(i, atom1b, atom2b, r1b, r2b, r3b, r4b, forceConstantb, doing_ecob, eco_factorb, eco_constantb, eco_linearb, res_index1b, res_index2b, globalIndexb);
